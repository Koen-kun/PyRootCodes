...
#Expected areas
obsH1 = ROOT.TF1("obsH1","gausn(0)",-9,-1)
obsH1.SetParameters(1,0,2.2)
obsH0 = ROOT.TF1("obsH0","gausn(0)",-1,8)
obsH0.SetParameters(1,-2,2)

#Observed
obs = ROOT.TLine(-1,0.22,-1,0.)
...
#Expected areas
obsH1.SetFillStyle(1001)
obsH1.SetFillColor(ROOT.kRed-10)
obsH1.SetLineColor(ROOT.kRed)
obsH1.SetLineWidth(4)
obsH0.SetFillStyle(1001)
obsH0.SetFillColor(ROOT.kBlue-10)
...
#text2.Draw()
textobs = ROOT.TPaveText(.40,0.72,0.60,0.9,"NDC") #Doesn't show up without NDC!
